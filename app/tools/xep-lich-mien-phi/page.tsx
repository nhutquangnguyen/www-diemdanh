      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {step === 5 && generatedSchedule && (
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            {/* Stats Cards */}
            <div ref={helpRef} className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              {/* Độ Phủ */}
              ...
              <div className="bg-green-50 rounded-lg p-4 relative">
                ...
                <div className="text-2xl font-bold text-green-600">{generatedSchedule.stats.fairnessScore}/100</div>
            ...
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl p-8 text-white text-center">
              <h3 className="text-2xl font-bold mb-3">🎉 Hài lòng với lịch này?</h3>
              <p className="text-lg mb-6 text-purple-100">
                Đăng ký <strong>MIỄN PHÍ</strong> để lưu lịch, gửi cho nhân viên, và tính lương tự động!
              </p>
              <div className="grid md:grid-cols-3 gap-4 mb-6 text-left">
                <div className="bg-white/10 rounded-lg p-4">
                  <div className="text-2xl mb-2">📱</div>
                  <div className="font-semibold mb-1">Gửi lịch tự động</div>
                  <div className="text-sm text-purple-100">Nhân viên nhận thông báo qua SMS/Email</div>
                </div>
                <div className="bg-white/10 rounded-lg p-4">
                  <div className="text-2xl mb-2">💰</div>
                  <div className="font-semibold mb-1">Tính lương tự động</div>
                  <div className="text-sm text-purple-100">Chấm công GPS + tính lương chính xác</div>
                </div>
                <div className="bg-white/10 rounded-lg p-4">
                  <div className="text-2xl mb-2">∞</div>
                  <div className="font-semibold mb-1">Không giới hạn</div>
                  <div className="text-sm text-purple-100">Nhân viên, ca, tuần, tháng không giới hạn</div>
                </div>
              </div>
              <a
                href="/auth/signup"
                className="inline-block bg-white text-purple-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transition-all shadow-lg"
              >
                Đăng ký miễn phí ngay →
              </a>
              <p className="mt-4 text-sm text-purple-200">Không cần thẻ tín dụng • Dùng thử 14 ngày miễn phí</p>
            </div>
